...
<body>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by <span><a target="_blank">Nand</a></span></p>
				</div>
			</div>
		</div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      <form class="" action="/AddCart" method="post">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dissmis="modal">&times;</button>
            <h4 class="modal-title">Masukkan Jumlah</h4>
          </div>
          <div class="modal-body">
            <input type="hidden" id="id_barang" class="id_barang" name="id_barang" value="3487">
            <div class="form-group">
              <label for="ExampleInputEmail">Jumlah Beli</label>
          ...
          <div class="modal-footer">
            ...
            <button type="button" name="btn btn-default" data-dissmis="modal">Close</button>
          </div>
        </div>
      </form>
    </div>
